...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else
        {
            ...
            if (youPos >= 0 && findKeyword(statement, "me", youPos) >= 0)
            {
                response = transformYouMeStatement(statement);
            }
            else if (IPos >= 0 && findKeyword(statement, "you", IPos) >= 0)
            {   
                System.out.println("I you statment");
    ...
    private String transFormIYouStatement(String statement)
    {
        ...
        int youPosition = findKeyword (statement, "you", 0);
        int position = findKeyword (statement, "I", 0);
        String inBetweenStatement = statement.substring(position+1, youPosition).trim();
        String lastChar = inBetweenStatement.substring(inBetweenStatement.length() - 1);
        if (lastChar.equals("."))
        {
            inBetweenStatement = inBetweenStatement.substring(0, inBetweenStatement.length() - 1);
        }
        return "Why do you " + inBetweenStatement + " me?";
    }
