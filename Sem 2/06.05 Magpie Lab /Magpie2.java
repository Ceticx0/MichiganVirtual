...
public class Magpie2
{
    ...
    public String getResponse(String statement) {
        ...
        else if (findKeyword(statement, "Shawver.") >= 0) {
            response = "She sounds like a good teacher.";
        }
        else if (findKeyword(statement, "computer") >= 0) {
            response = "What do you know about computers?";
        }
        else if (findKeyword(statement, "gamble") >= 0) {
            response = "Please don't gamble";
        }
        else if (findKeyword(statement, "pen") >= 0) {
            response = "NEVER MENTION PENS AROUND ME AGAIN!";
        }
    ...
    private String getRandomResponse() {
        ...
        if (whichResponse == 0) {
            ...
            response = "Stop Yapping.";
        }
        else if (whichResponse == 5) {
            response = "Could you repeat that a bit betterly?";
        }
